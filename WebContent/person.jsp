								...
								<div class="row">
									<div class="col-sm-12 wrapper-person">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="documentType"
												placeholder="documentType" pattern="[a-zA-Z]{3}"
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="documentNumber"
												placeholder="documentNumber" pattern="[0-9]{1-9}"
										...
										<div class="col-sm-10 wrapper-person">
											<div class="form-group">
												...
												placeholder="dateBirth" required />
											</div>
											<div class="form-group">
												<label>Sexo</label>
									...
									<div class="col-sm-10 wrapper-person">
										...
										<div class="form-group">
											...
											placeholder="monthlyIncome" pattern="[0-9]{8,2}" required />
										</div>
									</div>
								</div>
							</div>
